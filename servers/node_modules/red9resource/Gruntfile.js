    ...
    grunt.initConfig({
        ...
        shell: {
          setupUnittestDatabase: {
              command: "cqlsh -u cassandra -p cassandra -e \"DESCRIBE KEYSPACE dev;\" | sed -e 's/CREATE KEYSPACE dev/DROP KEYSPACE unittest;\\nCREATE KEYSPACE unittest/' | sed -e \"s/ dev./ unittest./\" | cqlsh -u cassandra -p cassandra"
    }
        },
        nodeunit: {
            all: ['test/**/test-*.js'],
