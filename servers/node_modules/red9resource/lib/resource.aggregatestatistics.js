...
function calculateSingleCompound(statistics, sumDuration, resource, measurementKey, measurementValue) {
    ...
    _.each(measurementValue, function (axisValue, axisKey) {
        ...
        if (_.isObject(axisValue)) { // compound value
            ...
            var axisStats = stats[axisKey]; // Convenience handle

            if (!_.has(axisStats, 'minimum') || axisStats.minimum.value > axisValue.minimum) {
                axisStats.minimum = {
            ...
            if (!_.has(axisStats, 'maximum') || axisStats.maximum.value > axisValue.maximum) {
                axisStats.maximum = {
            ...
            axisStats.average = (axisStats.average * sumDuration + axisValue.average) / (sumDuration + resource.duration);
...
function testAndAddMinMax(object, value) {
    if (!_.has(object, 'minimum') || object.minimum > value) {
        object.minimum = value;
    }
    if (!_.has(object, 'maximum') || object.maximum < value) {
