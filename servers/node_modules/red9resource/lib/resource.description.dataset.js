...
module.exports = {
    ...
    models: {
        ...
        resultOptions: {
            'expand': Joi.array().includes(Joi.valid(['owner', 'event', 'video', 'comment', 'count'])).description('Embed the owner resource into the result object, or all the associated events'),
        },
        ...
        search: {
            'id': validators.multiCSV(basicModel.id),
            'idList': validators.multiCSV(basicModel.id),
            'startTime': basicModel.startTime,
            ...
            'ownerId': validators.multiCSV(basicModel.ownerId),
            'title': basicModel.title,
