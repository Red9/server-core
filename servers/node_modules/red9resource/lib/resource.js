...
function addResource(resourceDescription) {
     ...
     * @param callback {err, ???}
     */
    result.create = function (newResource, callback) {
        crud.create(resourceDescription, newResource, callback);
    };
...
exports['helpers'] = {
     ...
     */
    createDataset: function createDataset(panel, resource, newDataset, panelStream, callback) {
