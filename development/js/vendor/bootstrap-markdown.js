...
define(['vendor/jquery', 'vendor/markdown'], function($, markdown) {
    !function($) {
            ...
            , showEditor: function() {
                ...
                if (this.$editor == null) {
                    ...
                    if (options.savable) {
                        ...
                        editorFooter.append('<div class="checkbox" data-name="saveCurrentViewCheckbox"><label><input type="checkbox"> Save current view with comment</label></div>'
                ...
                [{
                        ...
                        data: [{
                                ...
                                callback: function(e) {
                                    ...
                                    // transform selection and set the cursor into chunked text
                                    if ((pointer = 5, content.substr(selected.start - pointer, pointer) == '#### ')
