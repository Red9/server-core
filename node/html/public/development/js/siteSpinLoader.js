...
function SiteSpinLoader(targetId) {
    
    console.log("Make new spin loader: " + targetId);
    var self = this;

    this.loader = new Sonic({
        width: 100,
        height: 100,
        stepsPerFrame: 4,
        trailLength: 0.8,
        ...
        step: function(point, index, frame) {
            ...
            self.drawFlame.call(this, '#FF3333', point.x * index, point.y, radius);
            self.drawFlame.call(this, '#FF3333', 100 - point.x * index, point.y, radius);
...
SiteSpinLoader.prototype.drawFlame = function(color, px, py, radius) {
...
SiteSpinLoader.prototype.start = function() {
    this.loader.play();
};
